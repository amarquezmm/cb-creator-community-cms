...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    articleContent: Schema.Attribute.DynamicZone<
      ['shared.media', 'shared.rich-text']
    >;
    articleThumb: Schema.Attribute.Media<'images'>;
...
export interface ApiBecomeACreatorBecomeACreator
  extends Struct.SingleTypeSchema {
  collectionName: 'become_a_creator_pages';
  info: {
    displayName: 'Become a Creator';
    pluralName: 'become-a-creator-pages';
    singularName: 'become-a-creator';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::become-a-creator.become-a-creator'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Title: Schema.Attribute.String;
...
export interface ApiCommunityHighlightCommunityHighlight
  extends Struct.CollectionTypeSchema {
  collectionName: 'community_highlights';
  info: {
    displayName: 'Community Highlight';
    pluralName: 'community-highlights';
    singularName: 'community-highlight';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::community-highlight.community-highlight'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    eventHero: Schema.Attribute.Media<'images'>;
    eventRSVPLink: Schema.Attribute.String;
    eventThumb: Schema.Attribute.Media<'images'>;
    eventWebsiteLink: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
